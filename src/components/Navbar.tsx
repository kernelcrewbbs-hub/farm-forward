...
import { Leaf, Menu, X, Home, Cloud, Wheat, DollarSign, Warehouse, MessageSquare } from "lucide-react";
    ...
    >
      ...
      >
        <div className="container mx-auto px-4 py-4 space-y-2">
          ...
          <button className="w-full mt-4 px-5 py-3 bg-primary text-primary-foreground rounded-xl font-medium">
            Get Started
          </button>
        </div>
      </motion.div>
